...
class RawMaterialAdmin(admin.ModelAdmin):
    list_display = ['reference', 'designation', 'category', 'unit_of_measure', 
                   'reference_price', 'get_current_stock', 'get_stock_status', 'is_active']
...
class FinishedProductAdmin(admin.ModelAdmin):
    list_display = ['reference', 'designation', 'sales_unit', 'reference_selling_price',
                   'get_current_stock', 'get_stock_status', 'is_active']
