...
urlpatterns = [
    ...
    path(
        "raw-materials/<int:material_id>/toggle-active/",
        views.raw_material_toggle_active,
        name="raw_material_toggle_active",
    ),
    path(
        "raw-materials/<int:material_id>/delete/",
    ...
    path(
        "finished-products/<int:product_id>/delete/",
        views.finished_product_delete,
        name="finished_product_delete",
    ),
    path(
