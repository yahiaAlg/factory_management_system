...
urlpatterns = [
    ...
    path('<int:expense_id>/mark-paid/', views.expense_mark_paid, name='expense_mark_paid'),
    
    # Supporting Documents
    path('<int:expense_id>/add-document/', views.supporting_document_create, name='supporting_document_create'),
