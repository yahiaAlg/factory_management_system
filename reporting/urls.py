...
urlpatterns = [
    ...
    path(
        "financial-result/",
        views.financial_result_report,
        name="financial_result_report",
    ),
    path(
        "receivables-aging/",
        views.receivables_aging_report,
        name="receivables_aging_report",
    ),
    path("payables-aging/", views.payables_aging_report, name="payables_aging_report"),
    # Operational Reports
    path(
        "production-yield/",
        views.production_yield_report,
    ...
    path(
        "stock-valuation/", views.stock_valuation_report, name="stock_valuation_report"
    ),
    # Export
    path(
