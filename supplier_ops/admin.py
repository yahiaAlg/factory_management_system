...
class SupplierDNAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Statut", {"fields": ("status", "validated_by", "validated_at")}),
        ("Montants", {"fields": ("total_amount_ht",)}),
        ("Observations", {"fields": ("remarks",)}),
        (
            "Métadonnées",
            {
...
class SupplierAccountPaymentAdmin(admin.ModelAdmin):
    list_display = [
        "reference",
        "supplier",
        "payment_date",
